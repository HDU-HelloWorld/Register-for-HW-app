<template>
  ...
  <view class="quetions-content">
    <img :src="quetionContent" alt="可爱捏" class="question-img">
  </view>
  ...
  <view v-if="current == 'answer'" class="view-answer">
    <img :src="quetionAns" class="answer-img" mode="widthFix ">
    <view class="tips">
      对于答案和解析有任何疑问，欢迎加入用户交流群反馈
    </view>
  </view>
  <view v-if="current == 'analy'" class="view-analysis">
    <img :src="quetionAnaly" class="analysis-img">
    <view class="tips">
      对于答案和解析有任何疑问，欢迎加入用户交流群反馈
    </view>
  </view>
...
import quetionContent from '@/static/bushquestions/1.jpg'
import quetionAns from '@/static/bushquestions/3.jpg'
import quetionAnaly from '@/static/bushquestions/4.jpg'
